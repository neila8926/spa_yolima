        ...
        <div class="men fixed-top">
            ...
            <nav class="navbar navbar-expand-lg ">
                ...
                <div class="jumbotron jumbotron-fluid jumbo-somos" >
                    <div class="container">
                        <h1 class="display-4">Novedades y Promociones</h1>
            ...
            <section class="container">
                <div class="row">
                        <div class="col">
                            <blockquote class="blockquote">
                                <h3 class="titulo-promo">Super Promo de Diciembre</h3>
                                <ul>
                                    <li>
                                        <h4>Combo 1</h4>
                                        <p>Limpieza Facial + Masaje Relajante</p>
                                    </li>
                                    <li>
                                        <h4>Combo 2</h4>
                                        <p>Limpieza Facial + Microdermoabración</p>
                                    </li>
                                    <li>
                                        <h4>Combo 3</h4>
                                        <p>Masaje Relajante + Microdermoabración</p>
                                    </li>
                                </ul>
                    ...
                    <div class="col colum-img">
                        <div class="card-index">
                            <div class="imagen-tarjeta">
                                    <img class="card-img-top" src="img/YOLIMA_SPA.jpg" alt="Relajación">
                            </div>
                ...
                <div class="card-index">
                        <div class="img-promo">
                            <img class="card-img-top" src="img/navidad.jpg" alt="Card image cap">
                        </div>
