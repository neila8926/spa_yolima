...
<body>
        ...
        <div class="men fixed-top">
            ...
            <nav class="navbar navbar-expand-lg ">
                ...
                <div class="jumbotron jumbotron-fluid jumbo-somos" >
                    <div class="container">
                ...
                <div class="row">
                        <div class="col">
                            <blockquote class="blockquote">
                                <p >Con amplia experiencia y conocimiento en el campo de la estetica y belleza corporal. Cuyo fiel objetivo es brindar al cliente la mejor experiencia en atención y servicios.</p>
                                <p >Nuestros clientes encontrarán un lugar acogedor y relajante, que cuenta con servicios y productos de alta calidad para garantizar los mejores resultados.</p>
                            </blockquote>
                            <blockquote class="blockquote">
                                <p>Estamos ubicados en la Av Pedro de Heredia, Centro comercial Portal Cuatro Vientos, además brindamos servicios a domicilio con cita previa</p>
                                
                            </blockquote>
                        </div>
                
                    <div class="col colum-img">
                        <div class="card-index">
                            <div class="imagen-tarjeta">
                                    <img class="card-img-top" src="img/relajacion.jpg" alt="Relajación">
                            </div>
